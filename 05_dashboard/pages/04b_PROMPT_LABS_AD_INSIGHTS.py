...
st.set_page_config(page_title="AGENTIC PROMPT LABS: Monetization Strategy", layout="wide")
st.title("AGENTIC PROMPT LABS: Monetization Strategy")
...
with col2:
    ...
    st.caption("Source: GitHub & ArXiv Telemetry")
