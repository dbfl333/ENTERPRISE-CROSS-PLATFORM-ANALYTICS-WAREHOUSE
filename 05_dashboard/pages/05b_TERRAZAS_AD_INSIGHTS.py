...
st.set_page_config(page_title="TERRAZAS VENUE: Yield & Ad Targeting", layout="wide")
st.title("TERRAZAS VENUE: Yield & Ad Targeting")
...
with col2:
    ...
    st.caption("Source: Local Event Booking DB")
