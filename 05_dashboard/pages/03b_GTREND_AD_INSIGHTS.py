...
st.set_page_config(page_title="GTREND SCREENER: Ad Insights & Targeting", layout="wide")
st.title("GTREND SCREENER: Ad Insights & Targeting")
...
with col2:
    ...
    st.caption("Source: Binance & Crypto Sentiment Data")
